...
namespace AppServiceTimeStamp.dateTimeStamp {
    using System;
    ...
    public partial class Service1 : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback getCurrentDateAndTimeOperationCompleted;
        
        private bool useDefaultCredentialsSetExplicitly;
        
        /// <remarks/>
        public Service1() {
            this.Url = global::AppServiceTimeStamp.Properties.Settings.Default.AppServiceTimeStamp_dateTimeStamp_Service1;
        ...
        /// <remarks/>
        public event getCurrentDateAndTimeCompletedEventHandler getCurrentDateAndTimeCompleted;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/IService1/getCurrentDateAndTime", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        [return: System.Xml.Serialization.XmlElementAttribute(IsNullable=true)]
        public string getCurrentDateAndTime() {
            object[] results = this.Invoke("getCurrentDateAndTime", new object[0]);
            return ((string)(results[0]));
        }
        
        /// <remarks/>
        public void getCurrentDateAndTimeAsync() {
            this.getCurrentDateAndTimeAsync(null);
        }
        
        /// <remarks/>
        public void getCurrentDateAndTimeAsync(object userState) {
            if ((this.getCurrentDateAndTimeOperationCompleted == null)) {
                this.getCurrentDateAndTimeOperationCompleted = new System.Threading.SendOrPostCallback(this.OngetCurrentDateAndTimeOperationCompleted);
            }
            this.InvokeAsync("getCurrentDateAndTime", new object[0], this.getCurrentDateAndTimeOperationCompleted, userState);
        }
        
        private void OngetCurrentDateAndTimeOperationCompleted(object arg) {
            if ((this.getCurrentDateAndTimeCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.getCurrentDateAndTimeCompleted(this, new getCurrentDateAndTimeCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(Namespace="http://schemas.datacontract.org/2004/07/DateTimeService")]
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.6.1586.0")]
    public delegate void getCurrentDateAndTimeCompletedEventHandler(object sender, getCurrentDateAndTimeCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.6.1586.0")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class getCurrentDateAndTimeCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal getCurrentDateAndTimeCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
